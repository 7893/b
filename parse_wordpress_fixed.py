...
def convert_to_hugo_format(xml_file_path, output_dir="content"):
    ...
    for item in root.findall('.//item'):
        ...
        for category in item.findall('category'):
            ...
            if domain == 'category':
                if cat_name:  # Include all categories, including 'Uncategorized'
        ...
        # Don't automatically move tags to categories
        ...
        # Avoid duplicate frontmatter markers
